function h=vl_plotsiftdescriptor_col(d,f,varargin)
...
%
% This version has been modified in order to plot P-SIFT descriptors where
% histograms are arranged per-column.
